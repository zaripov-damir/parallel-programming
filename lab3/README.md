...
Измерение времени производится с помощью библиотеки **`std::chrono`**.

Корректность вычислений автоматически проверяется с помощью **Python** и библиотеки **NumPy**.
...
| Размер матрицы \ Количество процессов | 1 процесс | 2 процесса | 4 процесса | 8 процессов |
|:--------------:|----------:|-----------:|-----------:|------------:|
